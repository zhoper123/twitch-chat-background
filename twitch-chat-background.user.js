...
(function() {
    ...
    function getVignetteBackground() {
        return `
            linear-gradient(to top, rgba(0,0,0,${vignette}) 0%, rgba(0,0,0,0) ${vignetteRadius}%),
            linear-gradient(to bottom, rgba(0,0,0,${vignette}) 0%, rgba(0,0,0,0) ${vignetteRadius}%),
            linear-gradient(to left, rgba(0,0,0,${vignette}) 0%, rgba(0,0,0,0) ${vignetteRadius}%),
            linear-gradient(to right, rgba(0,0,0,${vignette}) 0%, rgba(0,0,0,0) ${vignetteRadius}%),
            rgba(0,0,0,${darkness})
        `;
    }
    ...
    window.setChatBackground = function(newScale, newOffsetX, newOffsetY, newDarkness, newVignette, newRadius) {
        ...
        if (newVignette !== undefined) vignette = newVignette;
        if (newRadius !== undefined) vignetteRadius = newRadius;
        updateBackground();
    }
